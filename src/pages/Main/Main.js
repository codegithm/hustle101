    ...
    <Container className={classes.container}>
      <div className={classes.position}>
        ...
        >
          ...
          <Grid item xs={2}>
            <Box
              bgcolor={iconColor === "profile" ? green[500] : green[50]}
              className={classes.lines}
            ></Box>
          </Grid>
          <Grid item xs={2}>
            <Box
              bgcolor={iconColor === "work" ? green[500] : green[50]}
              className={classes.lines}
            ></Box>
          </Grid>
          <Grid item xs={2}>
            <Box
              bgcolor={iconColor === "clock" ? green[500] : green[50]}
              className={classes.lines}
            ></Box>
          </Grid>
          <Grid item xs={2}>
            <Box
              bgcolor={iconColor === "rating" ? green[500] : green[50]}
              className={classes.lines}
            ></Box>
          </Grid>
        </Grid>
      </div>
      {iconColor === "home" ? <HomeComponent /> : ""}
      {iconColor === "profile" ? (
        <Profile
      ...
      {iconColor === "work" ? (
        <Jobs
          ...
          price="R3400"
          time="4hrs"
          description="I need a Frontend web developer to work frontend work with our developers"
        />
      ) : (
        ""
      )}
      {iconColor === "clock" ? (
        <Active name="Frontend dev" price="R3400" time="4hrs" />
      ) : (
        ""
      )}
    </Container>
