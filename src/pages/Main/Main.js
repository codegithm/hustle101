...
import { Home, HomeOutlined, Person,PersonOutline, Work,WorkOutline, Star, StarOutline, Timelapse, TimelapseOutlined } from "@material-ui/icons"
...
const Main = () =>{
    ...
    return(
        <Container className ={classes.container}>
            ...
            <Grid container 
             ...
             className={classes.grid}>
                 ...
                 <Grid className={classes.items} item xs={2}>
                    <Box onClick={clock}>
                        {
                            iconColor === "clock" ? <Timelapse color="secondary" /> : <TimelapseOutlined />
                        }
                    </Box>
                 </Grid>
                 <Grid className={classes.items} item xs={2}>
            ...
            <Gallery />
            {/* <Profile toggleState={toggle} toggle={handleToggle} name="John Doe" number="0747778776" /> */}
        </Container>
    )
}
